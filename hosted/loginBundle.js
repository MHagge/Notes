...
var renderLogin = function renderLogin() {
  ...
  return React.createElement(
    ...
    React.createElement("input", { name: "username", id: "username", maxLength: "25", type: "text", placeholder: "username" }),
    React.createElement(
      "label",
      { htmlFor: "password" },
      "PASSWORD"
...
var renderSignup = function renderSignup() {
  ...
  return React.createElement(
    ...
    React.createElement("input", { id: "username", maxLength: "25", type: "text", name: "username", placeholder: "username" }),
    React.createElement(
      "label",
      { htmlFor: "pass" },
      "PASSWORD"
