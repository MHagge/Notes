...
const renderLogin = function(){
  ...
  return(
    <form 
      ...
      <input name="username" id="username" maxLength="25" type="text" placeholder="username"></input>
...
const renderSignup = function(){
  ...
  return(
    <form 
      ...
      >
      <label htmlFor="username">USERNAME</label>
      <input id="username" maxLength="25" type="text" name="username" placeholder="username"/>
